...
export const CLIENT_SETTINGS: ClientSetting[] = [
  ...
  { key: "discord_status", kind: "boolean", fallback: true, backup: true },
  { key: "discord_time", kind: "boolean", fallback: true, backup: true },
  { key: "discord_model", kind: "boolean", fallback: true, backup: true },
  { key: "discord_environment", kind: "boolean", fallback: false, backup: true },
  { key: "discord_project", kind: "boolean", fallback: false, backup: true },
  ...
  { key: "shared_sort_field", kind: "string", fallback: "date", backup: true },
  { key: "shared_sort_ascending", kind: "boolean", fallback: false, backup: true },
